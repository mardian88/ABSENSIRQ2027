...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const isPublicRoute = pathname === "/" || pathname.startsWith("/psb") || pathname.startsWith("/login") || pathname.startsWith("/izin") || pathname.startsWith("/portal-guru") || pathname.startsWith("/portal-ortu") || pathname.startsWith("/mutabaah") || isKioskRoute;
